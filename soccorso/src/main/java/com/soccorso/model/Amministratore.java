...
public class Amministratore {
     ...
     */
// costruttore con ID
    public Amministratore(int ID, String nome, String cognome, String email, int matricola, LocalDate dataNascita) {
        this.ID = ID;
        this.nome = nome;
...
// costruttore senza ID
    public Amministratore(String nome, String cognome, String email, int matricola, LocalDate dataNascita) {
        this.nome = nome;
        this.cognome = cognome;
        this.email = email;
        this.matricola = matricola;
     ...
     */
    public void setAmministratoreAttivo() {
        this.attivo = true;
    }
     ...
     */
    public void setAmministratoreNonAttivo() {
        this.attivo = false;
    }
}